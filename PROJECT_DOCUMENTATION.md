...
| - | - | - |
| The graphs were very well implemented. The UI was also very nice for the graphs. The search data feature is very well made with a large variety of options. The change data successfully works, congratulations! | When printing out a list, the '' can be removed, not a major issue, only a small issue. The program could use clear screen at times to clear up the console. Certain functions require bug checking.| In future, you could go through the program and fix the program feel, making certain features feel smoother. Many practical features of the code do not require fixing, the functional part of the code are very well made. |

### Final Evaluation
The project accurately reflected the requirements outlined earlier in planning the Data Analysis. It could maintain Google Sheets (though a straight connection from Google Forms was more effective) and loaded data correctly. However, the data still had to be filtered and sorted for specific tables and graphs and while an 'overall rating' wasn't created, the transport_rating mean and graphs in relation to it gave enough data to answer the hypothesis. Median and mode along with min, max and number were added too for extra choice and difference, and both the show_tables and show_graphs functions worked with the hypothesis in mind. The system was tested to make sure that error could not be made, and while the UI was well-designed, no colours of text were added (however graphs had different colours). In terms of the Use Case, everything was added with the exception of implementing the README directly into the main file, instead acting as an external tab that can opened and read if the user wishes. Though some requirements only met half of the appropriate conditions, overall it well-reflected the plan that was created early on.

Peer Feedback for this analysis was surprisingly positive - the user only gave minor issues as negatives in the PMI Table. Graphs were implemented well, and as stated in the preceding paragraph, the UI was easy to read and simple to follow. Data for changing and searching - optional sections I added as both a challenge and to enhance the multitude of options available - were commended by the user for successfully working. Minor changes included removing unnecessary parts of a list, using more of the clear_screen function implemented earlier. More testing of the functions before evaluation was also recommended. Overall it was less about the code as a whole or what could be added but rather little nitpicks that - if fixed - would make the analysis feel much smoother and well-made.

I believe that the project was managed quite effectively. While I had a slow start with the first two areas - Identifying and Defining and Research and Planning - I gained traction once beginning code. Commits were frequent and while I didn't maintain them at the start, the latter half of the coding (primarily the past week) all had meaningful descriptions. There was more done near the end of the project, however it was more that I tried to add more and ended up running out of time for certain areas. It was only Monday when I began the graphs - arguably the most important part of answering the aim and hypothesis. However compared to previous Computer Technology assignments where I spent upwards of 50 hours at home adding additional code, this time I stuck to the criteria and focused more on making sure every part of it was in-depth and effective. It could've been managed better in the last couple of weeks, but overall enough was done while I didn't burn myself out too early.